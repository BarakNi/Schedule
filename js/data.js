...
// =====================================================================
// BASELINE LECTURES (static, always available offline)
// =====================================================================
const BASE = [
    { date:"2026-02-24", title:"Python Lecture 1 — Ilay", section:"python",
      ...
      files:[
        ...
        {n:"Python Fundamentals Lecture.pdf",u:V+"1tqv5KA2qdRyTczviw0K2dm1c6PlMTRDW/view",t:"pdf"},
        {n:"lesson1.py",u:V+"1Wb165lOLKkapd346TMNMD59zWhJDTMHU/view",t:"link"},
    ...
    { date:"2026-02-26", title:"Python Lecture 2 — Ilay", section:"python",
      ...
      files:[
        ...
        {n:"Python Lecture 2.pdf",u:V+"1zcAMFp-p_u3Roin1a_bwMEcVFLeH2yUy/view",t:"pdf"},
        {n:"lesson2.py",u:V+"1ysBQ7Cw6nNU_Y1RYsRSUwmTvwS-YqnkM/view",t:"link"},
    ...
    { date:"2026-03-03", title:"Python Lecture 3 — Ilay", section:"python",
      ...
      files:[
        ...
        {n:"Python Lecture 3.pdf",u:V+"1L1eBEd2JA-FOLDNm7qcGLs-nUWjM_cf1/view",t:"pdf"},
        {n:"lesson3.py",u:V+"1cyI1StwbGD_bNy9egkdLxC7qbpjJo9DC/view",t:"link"},
        {n:"lesson3.ipynb",u:V+"1q3BEjDGfivHuRYIdj19-fnadTkySE6Kv/view",t:"notebook"},
        {n:"lesson3_animal_abstract.py",u:V+"1j2xrfwHLPmLSjmewuHqev303U6H81vjv/view",t:"link"},
        {n:"lesson3_animal_solution.py",u:V+"1N2FJmqB8QntQlnlcPkfNVOmqQKQVeGD0/view",t:"link"},
    ...
    { date:"2026-03-11", title:"Tirgul 2 — Exercise Session", section:"python",
      ...
      files:[
        ...
        {n:"Python_Prctice_class_2.ipynb",u:V+"1bsmxrI8z85r6OakPzuXIL7eK0OBE-wkK/view",t:"notebook"},
        {n:"main.py",u:V+"1q6d9CvAuzrjstM4EONp-AiIHIEwfaK_l/view",t:"link"},
        {n:"models.py",u:V+"1zix8c2lefd5TNzhUAJTVtkgLs5HMpwHL/view",t:"link"},
        {n:"utils.py",u:V+"1OPK94dJ8fi9BtBltIdk_Gb3KelOnc8aN/view",t:"link"},
        {n:"📁 class2 Folder",u:F.exClass2,t:"link"},
    ...
    { date:"2026-03-12", title:"Python Lecture 4 — Ilay", section:"python",
      ...
      files:[
        ...
        {n:"Python Lecture 4.pdf",u:V+"1U4ZONfn-NU1ha_PVgP896HLXG6EDZnWv/view",t:"pdf"},
        {n:"lesson4.py",u:V+"173aqoX0Swlw_CUFrwIIwUZD0bAv4I8z5/view",t:"link"},
        {n:"lesson4Int.ipynb",u:V+"1J-cQGcJey8IeJuo5KCwC8TVNVJgFVT2S/view",t:"notebook"},
        {n:"lesson4_project1.py",u:V+"1nIWZCBxSbzx6YLve3WAC7-2rTZqbONUG/view",t:"link"},
        {n:"lesson4_project2.py",u:V+"1pTZrLsnVpkjbqJjFfG2Ydf09b_goY-3P/view",t:"link"},
    ...
    { date:"2026-03-17", title:"Tirgul 3 — Exercise Session", section:"python",
      ...
      files:[
        {n:"class3.ipynb",u:V+"1JTxFTOpYq4V1elepHeQGsyz50cYoIarK/view",t:"notebook"},
        {n:"config.json",u:V+"1dQhFK-JKTzXOZgFohxQyJIqPkpl5g23j/view",t:"link"},
        {n:"data.txt",u:V+"1Dd7aJ2dbpsycsheQYnyefpue8SQELOTY/view",t:"link"},
        {n:"products.csv",u:V+"19vxC9zSawFzYF8vhGvP_G9AdNPYGL5b6/view",t:"link"},
        {n:"📁 class3 Folder",u:D+"116qIL9rDMXrWRpA_o6pFr3h5JxNzbTc-",t:"link"},
    ...
    { date:"2026-03-17", title:"AI Lecture 1 — Zvi: Intro + DS Foundations", section:"lectures",
      ...
      files:[
        ...
        {n:"1. Intro.pdf",u:V+"1fWKnIMEjVvIStnpf9DlKe5ACQegPi0Xq/view",t:"pdf"},
